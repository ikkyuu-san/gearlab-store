-- CreateEnum
CREATE TYPE "ProductStockStatus" AS ENUM ('PREORDER', 'IN_STOCK', 'OUT_OF_STOCK');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'PROCESSING', 'SHIPPED', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "ContactMethod" AS ENUM ('PHONE', 'FACEBOOK', 'VIBER', 'TELEGRAM');
...
CREATE TABLE "Product" (
    ...
    "imageUrl" TEXT,
    "stockStatus" "ProductStockStatus" NOT NULL DEFAULT 'PREORDER',
